...
const contacts: IContact[] = [
  {
    label: "Email",
    link: "mailto:chrishj31@gmail.com",
    icon: (
  ...
  {
    label: "LinkedIn",
    link: "http://linkedin.com/in/christopherjiang",
    icon: (
  ...
  {
    label: "GitHub",
    link: "http://github.com/chrisisonline",
    icon: (
  ...
  {
    label: "Medium",
    link: "https://medium.com/@cj.design",
    icon: (
...
export default function Contact() {
  return (
    <section id="contact">
      ...
      <p className="mb-6">
        Here are some other places you can find me! The best way to reach me is
        via email
      </p>
      <div className="flex flex-wrap items-start gap-4 md:gap-10">
        {contacts.map(({ label, link, icon }) => (
          ...
          >
            <button className="flex min-w-24 flex-col items-center gap-4 rounded-xl border-2 border-primary p-3 pt-5">
              <span className="flex h-6 w-6 items-center justify-center fill-primary">
                {icon}
              </span>
              {label}
            </button>
